...
async function drawBiplot(toPlot1, toPlot2,data3) {
    ...
    div.innerHTML = '<li><span class="whitedot"></span><text> Cluster 0</text></li><br></br><li><span class="bluedot"></span><text> Cluster 1</text></li><br></br><li><span class="greendot"></span><text> Cluster 2</text></li><br></br>';
    ...
    biplotcolor = ["white","rgb(32, 123, 241)","rgb(38, 192, 97)"];
